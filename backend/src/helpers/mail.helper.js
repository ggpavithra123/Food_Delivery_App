...
export const sendEmailReceipt = function (order) {
  console.log("order in sendEmailReceipt:",order);   
  const mailClient = getClient();
  console.log("sendEmailReceipt:")
  mailClient.messages
    .create('sandbox18528c22856c42ef9652bf113d2000e8.mailgun.org', {
      from: "Mailgun Sandbox <postmaster@sandbox18528c22856c42ef9652bf113d2000e8.mailgun.org>",
      to: "pavithra <ggpavi12@gmail.com>",
